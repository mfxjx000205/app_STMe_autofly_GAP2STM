...
void ProcessAndTransfer(){
    coordinate_t buffer[5] = {0};
    
    static CPXPacket_t rxPacket={0};
    uint16_t a;
    cpxGetRxPacket(&a);
    DEBUG_PRINT("a is %d\n",a);
